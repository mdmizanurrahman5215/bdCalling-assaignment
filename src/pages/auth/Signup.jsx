        ...
        <form className="space-y-4 sm:space-y-5">
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-3 sm:px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:outline-none"
            />
          </div>
          ...
          <button
            type="submit"
            className="w-full bg-primary text-white py-2.5 sm:py-3 rounded-lg font-medium hover:bg-primary/90 transition"
          >
            Sign Up
          </button>
